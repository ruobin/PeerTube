...
function doesChangeVideoOwnershipExist(id, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadVideoChangeOwnership(id)];
                case 1:
                    videoChangeOwnership = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (validator.isInt(id)) {
                return [2 /*return*/, video_change_ownership_1.VideoChangeOwnershipModel.load(parseInt(id, 10))];
            }
