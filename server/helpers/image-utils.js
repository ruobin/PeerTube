...
function processImage(path, destination, newSize, keepOriginal) {
    if (keepOriginal === void 0) { keepOriginal = false; }
    return __awaiter(this, void 0, void 0, function () {
        var buf, sharpInstance;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fs_extra_1.remove(destination)];
                case 2:
                    _a.sent();
                ...
                case 3:
                    _a.sent();
                    if (!(keepOriginal !== true)) return [3 /*break*/, 5];
