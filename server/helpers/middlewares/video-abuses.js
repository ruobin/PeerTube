...
function doesLocalVideoChannelNameExist(name, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, video_channel_1.VideoChannelModel.loadLocalByNameAndPopulateAccount(name)];
                case 1:
                    videoChannel = _a.sent();
                    return [2 /*return*/, processVideoChannelExist(videoChannel, res)];
            }
        });
    });
}
...
function doesVideoChannelIdExist(id, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, video_channel_1.VideoChannelModel.loadAndPopulateAccount(+id)];
                case 1:
                    videoChannel = _a.sent();
                    return [2 /*return*/, processVideoChannelExist(videoChannel, res)];
            }
...
function doesVideoChannelNameWithHostExist(nameWithDomain, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, video_channel_1.VideoChannelModel.loadByNameWithHostAndPopulateAccount(nameWithDomain)];
                case 1:
                    videoChannel = _a.sent();
                    return [2 /*return*/, processVideoChannelExist(videoChannel, res)];
            }
