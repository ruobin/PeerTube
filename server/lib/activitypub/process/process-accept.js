...
function processAcceptActivity(options) {
    return __awaiter(this, void 0, void 0, function () {
        var targetActor, inboxActor;
        return __generator(this, function (_a) {
            targetActor = options.byActor, inboxActor = options.inboxActor;
            if (inboxActor === undefined)
                throw new Error('Need to accept on explicit inbox.');
            return [2 /*return*/, processAccept(inboxActor, targetActor)];
        });
    });
}
...
function processAccept(actor, targetActor) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, actor_follow_1.ActorFollowModel.loadByActorAndTarget(actor.id, targetActor.id)];
                case 1:
                    follow = _a.sent();
                    if (!follow)
                        throw new Error('Cannot find associated follow.');
                    if (!(follow.state !== 'accepted')) return [3 /*break*/, 4];
                    follow.set('state', 'accepted');
                    return [4 /*yield*/, follow.save()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, actor_1.addFetchOutboxJob(targetActor)];
                case 3:
                    _a.sent();
                    _a.label = 4;
