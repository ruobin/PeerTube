...
function processLikeActivity(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, database_utils_1.retryTransactionWrapper(processLikeVideo, byActor, activity)];
        });
    });
}
...
function processLikeVideo(byActor, activity) {
    return __awaiter(this, void 0, void 0, function () {
        var videoUrl, byAccount, video;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    videoUrl = activitypub_1.getAPId(activity.object);
                    byAccount = byActor.Account;
                    if (!byAccount)
                        throw new Error('Cannot create like with the non account actor ' + byActor.url);
                    return [4 /*yield*/, videos_1.getOrCreateVideoAndAccountAndChannel({ videoObject: videoUrl })];
                case 1:
                    video = (_a.sent()).video;
                    return [2 /*return*/, initializers_1.sequelizeTypescript.transaction(function (t) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        url = url_1.getVideoLikeActivityPubUrl(byActor, video);
                                    ...
                                    case 1:
                                        ...
                                        if (existingRate && existingRate.type === 'like')
                                            return [2 /*return*/];
                                        if (!(existingRate && existingRate.type === 'dislike')) return [3 /*break*/, 3];
                                        return [4 /*yield*/, video.decrement('dislikes', { transaction: t })];
                                    case 2:
                                        _a.sent();
                                        _a.label = 3;
                                    case 3: return [4 /*yield*/, video.increment('likes', { transaction: t })];
                                    case 4:
                                        _a.sent();
