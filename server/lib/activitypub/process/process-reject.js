...
function processRejectActivity(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, processReject(inboxActor, targetActor)];
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, initializers_1.sequelizeTypescript.transaction(function (t) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, actor_follow_1.ActorFollowModel.loadByActorAndTarget(follower.id, targetActor.id, t)];
                            case 1:
                                actorFollow = _a.sent();
                                if (!actorFollow)
