...
function processViewActivity(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, processCreateView(activity, byActor)];
        });
    });
}
...
function processCreateView(activity, byActor) {
    return __awaiter(this, void 0, void 0, function () {
        var videoObject, options, video, exceptions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    videoObject = activity.type === 'View' ? activity.object : activity.object.object;
                    options = {
                        videoObject: videoObject,
                        fetchType: 'only-video'
                    };
                    return [4 /*yield*/, videos_1.getOrCreateVideoAndAccountAndChannel(options)];
                case 1:
                    video = (_a.sent()).video;
                    return [4 /*yield*/, redis_1.Redis.Instance.addVideoView(video.id)];
                case 2:
                    _a.sent();
