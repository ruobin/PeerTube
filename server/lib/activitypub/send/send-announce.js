...
function buildAnnounceWithVideoAudience(byActor, videoShare, video, t) {
    return __awaiter(this, void 0, void 0, function () {
        var announcedObject, actorsInvolvedInVideo, audience, activity;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    announcedObject = video.url;
                ...
                case 1:
                    ...
                    activity = buildAnnounceActivity(videoShare.url, byActor, announcedObject, audience);
                    return [2 /*return*/, { activity: activity, actorsInvolvedInVideo: actorsInvolvedInVideo }];
            }
        });
    });
}
...
function sendVideoAnnounce(byActor, videoShare, video, t) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, activity, actorsInvolvedInVideo, followersException;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, buildAnnounceWithVideoAudience(byActor, videoShare, video, t)];
                case 1:
                    _a = _b.sent(), activity = _a.activity, actorsInvolvedInVideo = _a.actorsInvolvedInVideo;
                    logger_1.logger.info('Creating job to send announce %s.', videoShare.url);
                    followersException = [byActor];
                    return [2 /*return*/, utils_1.broadcastToFollowers(activity, byActor, actorsInvolvedInVideo, t, followersException)];
            }
        });
    });
}
