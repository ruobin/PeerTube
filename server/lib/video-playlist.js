...
function createWatchLaterPlaylist(account, t) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    videoPlaylist = new video_playlist_1.VideoPlaylistModel({
                        name: 'Watch later',
                    ...
                    videoPlaylist.url = activitypub_1.getVideoPlaylistActivityPubUrl(videoPlaylist); // We use the UUID, so set the URL after building the object
                    return [4 /*yield*/, videoPlaylist.save({ transaction: t })];
                case 1:
                    _a.sent();
