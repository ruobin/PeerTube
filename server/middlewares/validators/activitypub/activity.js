...
var activity_1 = require("../../../helpers/custom-validators/activitypub/activity");
var logger_1 = require("../../../helpers/logger");
var utils_1 = require("../../../helpers/utils");
function activityPubValidator(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var serverActor, remoteActor;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!activity_1.isRootActivityValid(req.body)) {
                        ...
                        return [2 /*return*/, res.status(400).json({ error: 'Incorrect activity.' })];
                    }
                    return [4 /*yield*/, utils_1.getServerActor()];
                case 1:
                    serverActor = _a.sent();
                    remoteActor = res.locals.signature.actor;
