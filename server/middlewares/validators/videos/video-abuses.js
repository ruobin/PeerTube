        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    if (!(_a.sent()))
                        return [2 /*return*/];
                    return [4 /*yield*/, middlewares_1.doesVideoAbuseExist(req.params.id, res.locals.video.id, res)];
                case 2:
                    if (!(_a.sent()))
                        return [2 /*return*/];
                    return [2 /*return*/, next()];
