...
var videosBlacklistRemoveValidator = [
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    if (!(_a.sent()))
                        return [2 /*return*/];
                    return [4 /*yield*/, middlewares_1.doesVideoBlacklistExist(res.locals.video.id, res)];
                case 2:
                    if (!(_a.sent()))
                        return [2 /*return*/];
...
var videosBlacklistAddValidator = [
    express_validator_1.param('videoId').custom(misc_1.isIdOrUUIDValid).not().isEmpty().withMessage('Should have a valid videoId'),
...
var videosBlacklistUpdateValidator = [
    express_validator_1.param('videoId').custom(misc_1.isIdOrUUIDValid).not().isEmpty().withMessage('Should have a valid videoId'),
    express_validator_1.body('reason')
        .optional()
        .custom(video_blacklist_1.isVideoBlacklistReasonValid).withMessage('Should have a valid reason'),
...
var videosBlacklistFiltersValidator = [
