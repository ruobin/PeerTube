            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (utils_1.areValidationErrors(req, res))
                        return [2 /*return*/];
                    nameWithHost = express_utils_1.getHostWithPort(req.query.resource.substr(5));
                    name = nameWithHost.split('@')[0];
